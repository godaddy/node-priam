...
DatastaxDriver.prototype.createConnectionPool = function createConnectionPool(poolConfig, waitForConnect, callback) {
  ...
  if (poolConfig.poolSize) {
    ...
    dsPoolConfig.pooling.coreConnectionsPerHost[cqlDriver.types.distance.local+''] = poolConfig.poolSize;
    dsPoolConfig.pooling.coreConnectionsPerHost[cqlDriver.types.distance.remote+''] = Math.ceil(poolConfig.poolSize / 2);
  }
