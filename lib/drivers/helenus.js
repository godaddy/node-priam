...
function HelenusDriver() {
    ...
    var consistencies = helenus.ConsistencyLevel;
...
HelenusDriver.prototype.getNormalizedResults = function getNormalizedResults(original) {
