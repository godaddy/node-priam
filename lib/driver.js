...
class DatastaxDriver extends EventEmitter {
  ...
  async _execCqlWithRetries(cqlQuery, dataParams, options, callback) {
    ...
    try {
        ...
        const executeRetryableCql = () => {
          operation.attempt(async currentAttempt => {
            ...
            try {
              ...
              const canRetryErrorType = this._canRetryError(err);
      ...
      if (callback) return void callback(null, result);
    } catch (err) {
