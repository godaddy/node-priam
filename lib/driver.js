...
class DatastaxDriver extends EventEmitter {
    ...
    return new Promise((resolve, reject) => {
      const executeRetryableCql = () => {
        operation.attempt(async currentAttempt => {
          ...
          try {
            const result = await this._recordQuery(queryRequestId, cqlQuery, dataParams, options, async options => {
  ...
  async _recordQuery(queryRequestId, cqlQuery, dataParams, options, act) {
    try {
