...
class DatastaxDriver extends EventEmitter {
  ...
  _initProviderOptions() {
    remapOption(this.config, 'hostPoolSize', 'poolSize');
    remapOption(this.config, 'cqlVersion', 'version');
    remapOption(this.config, 'user', 'username');
    remapOption(this.config, 'hosts', 'contactPoints');
  }
