...
* Updated `cassandra-driver` to version 4.8.0, to handle date/time values in modern versions of node.

**BREAKING**:

* Priam now requires node 18.0 or greater due to breaking changes in `cassandra-driver` which are required to support node 24.0.
